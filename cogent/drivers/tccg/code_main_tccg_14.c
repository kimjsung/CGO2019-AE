...
int main(int argc, char** argv)
{
	...
	printf ("==========================================================================================================\n");
    printf (">>> ab-cad-dcb\n");
    printf (">>> t3 [a,16,b,16] += sum(c,16) * t2 [c,a,d] * v2 [d,c,b];\n");
...
//
void post_Correctness(double* h_C, double* h_C_chk, double* h_A, double* h_B, int size_idx_a, int size_idx_b, int size_idx_c, int size_idx_d)
{
	//  ab-cad-dcb
    //  t3 [a,16,b,16] += sum(c,16) * t2 [c,a,d] * v2 [d,c,b];
