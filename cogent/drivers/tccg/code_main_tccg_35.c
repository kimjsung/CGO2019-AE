...
//
//# abcdef-dfgb-geac
//t3 [a,16,b,16,c,16,d,16,e,16,f,16] += sum(g,16) * t2 [d,f,g,b] * v2 [g,e,a,c];
//
int main(int argc, char** argv)
{
	...
	size_A = size_idx_d * size_idx_f * size_idx_g * size_idx_b;
	size_B = size_idx_g * size_idx_e * size_idx_a * size_idx_c;
	...
	printf ("==========================================================================================================\n");
	printf (">>> abcdef-dfgb-geac\n");
    printf (">>> t3 [a,16,b,16,c,16,d,16,e,16,f,16] += sum(g,16) * t2 [d,f,g,b] * v2 [g,e,a,c];\n");
...
void post_Correctness(double* h_C, double* h_C_chk, double* h_A, double* h_B, int size_idx_a, int size_idx_b, int size_idx_c, int size_idx_d, int size_idx_e, int size_idx_f, int size_idx_g)
{
    ...
    {   
        ...
        for (idx_g = 0; idx_g < size_idx_g; idx_g++)
        {
            ...
            h_C_chk[tmp_r_idx] += 	h_A[idx_d + (idx_f + (idx_g + (idx_b) * size_idx_g) * size_idx_f) * size_idx_d] * 
                                    h_B[idx_g + (idx_e + (idx_a + (idx_c) * size_idx_a) * size_idx_e) * size_idx_g];
            ops++;
        }
        tmp_ops = tmp_ops + ops;
    }
