...
//
//# abcdef-gebd-dfga
//t3 [a,16,b,16,c,16,d,16,e,16,f,16] += sum(g,16) * t2 [g,e,b,d] * v2 [d,f,g,a];
//
int main(int argc, char** argv)
{
	...
	size_A = size_idx_g * size_idx_e * size_idx_b * size_idx_c;
	size_B = size_idx_d * size_idx_f * size_idx_g * size_idx_a;
	...
	printf ("==========================================================================================================\n");
    printf (">>> abcdef-gebc-dfga\n");
    printf (">>> t3 [a,16,b,16,c,16,d,16,e,16,f,16] += sum(g,16) * t2 [g,e,b,c] * v2 [d,f,g,a];\n");
...
//
void post_Correctness(double* h_C, double* h_C_chk, double* h_A, double* h_B, int size_idx_a, int size_idx_b, int size_idx_c, int size_idx_d, int size_idx_e, int size_idx_f, int size_idx_g)
{
    //# abcdef-gebc-dfga
    //#     t3 [a,16,b,16,c,16,d,16,e,16,f,16] += sum(g,16) * t2 [g,e,b,c] * v2 [d,f,g,a];
    ...
    {   
        ...
        for (idx_g = 0; idx_g < size_idx_g; idx_g++)
        {
            ...
            h_C_chk[tmp_r_idx] += 	h_A[idx_g + (idx_e + (idx_b + (idx_c) * size_idx_b) * size_idx_e) * size_idx_g] * 
                                    h_B[idx_d + (idx_f + (idx_g + (idx_a) * size_idx_g) * size_idx_f) * size_idx_d];
            ops++;
        }
        tmp_ops = tmp_ops + ops;
    }
