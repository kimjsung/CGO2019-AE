...
int main(int argc, char** argv)
{
    ...
    // Run the Kernels
    //extern "C" void case_20_cuda(int ad, int bd, int cd, int dd, int ed, int fd, float *t3, float *t2, float *v2) {
...
void pre_Initializing_Input_Tensors(float* h_C,    float* h_C_chk,    int size_C,
									float* h_A,    int size_A,
                                    float* h_B,    int size_B)
{
	// t3
	int i, j;
	for (i = 0; i < size_C; i++)
...
//
void post_Correctness(float* h_C, float* h_C_chk, 
				    float* h_A,  float* h_B,
