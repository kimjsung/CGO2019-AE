...
int main(int argc, char** argv)
{
	...
	int size_B;
	int size_internal;
    long long int tmp_num = (long long int)((long long int)((long long int)((long long int)(size_idx_a * size_idx_b * size_idx_c * size_idx_d) * size_idx_e) * size_idx_f) * 2);
    ...
    // Run the Kernels
    initmemmodule_();
	tccg_20_cuda(size_idx_a, size_idx_b, size_idx_c, size_idx_d, size_idx_e, size_idx_f, host_C, host_A, host_B);
