...
//
//# abcdef-efgc-gdab
//t3 [a,16,b,16,c,16,d,16,e,16,f,16] += sum(g,16) * t2 [e,f,g,c] * v2 [g,d,a,b];
//
int main(int argc, char** argv)
{
	...
	size_A = size_idx_e * size_idx_f * size_idx_g * size_idx_c;
	size_B = size_idx_g * size_idx_d * size_idx_a * size_idx_b;
    ...
    // Run the Kernels
    initmemmodule_();
	tccg_39_cuda(size_idx_a, size_idx_b, size_idx_c, size_idx_d, size_idx_e, size_idx_f, size_idx_g, host_C, host_A, host_B);
				...
				int size_idx_a, int size_idx_b, int size_idx_c, int size_idx_d, int size_idx_e, int size_idx_f, int size_idx_g)
{
    ...
    {   
        ...
        for (idx_g = 0; idx_g < size_idx_g; idx_g++)
        {
            ...
            h_C_chk[tmp_r_idx] += 	h_A[idx_e + (idx_f + (idx_g + (idx_c) * size_idx_g) * size_idx_f) * size_idx_e] * 
                                    h_B[idx_g + (idx_d + (idx_a + (idx_b) * size_idx_a) * size_idx_d) * size_idx_g];
/*
            if (tmp_r_idx == 1616)
            {
                printf ("[%2d] t2[%8d]: %f, v2[%8d]: %f >> %f\n", idx_g, 
                                    idx_e + (idx_f + (idx_g + (idx_c) * size_idx_g) * size_idx_f) * size_idx_e,
                                    h_A[idx_e + (idx_f + (idx_g + (idx_c) * size_idx_g) * size_idx_f) * size_idx_e],
                                    idx_g + (idx_d + (idx_a + (idx_b) * size_idx_a) * size_idx_d) * size_idx_g,
                                    h_B[idx_g + (idx_d + (idx_a + (idx_b) * size_idx_a) * size_idx_d) * size_idx_g],
                                    h_C_chk[tmp_r_idx]);
            }
 */           
