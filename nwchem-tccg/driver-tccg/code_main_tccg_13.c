...
int main(int argc, char** argv)
{
	...
	size_A = size_idx_a * size_idx_c * size_idx_d;
	size_B = size_idx_d * size_idx_b * size_idx_c;
    ...
    // Run the Kernels
	initmemmodule_();
    tccg_13_cuda(size_idx_a, size_idx_b, size_idx_c, size_idx_d, host_C, host_A, host_B);
