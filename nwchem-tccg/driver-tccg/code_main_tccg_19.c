...
int main(int argc, char** argv)
{
	...
	int size_B;
	int size_internal;
    long long int tmp_num = (long long int)((long long int)(size_idx_a * size_idx_b * size_idx_c * size_idx_d * size_idx_e) * 2);

	//  #abc-adec-ebd
    //  t3 [a,16,b,16,c,16] += sum(e,16,d,16) * t2 [a,d,e,c] * v2 [e,b,d];
	size_internal   = size_idx_e * size_idx_d;
	size_C          = size_idx_a * size_idx_b * size_idx_c;
    size_A          = size_idx_a * size_idx_d * size_idx_e * size_idx_c;
	size_B          = size_idx_e * size_idx_b * size_idx_d;
    ...
    // Run the Kernels
    initmemmodule_();
    tccg_19_cuda(size_idx_a, size_idx_b, size_idx_c, size_idx_d, size_idx_e, host_C, host_A, host_B);
