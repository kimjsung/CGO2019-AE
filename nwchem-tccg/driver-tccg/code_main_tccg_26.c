...
int main(int argc, char** argv)
{
	...
	size_A = size_idx_a * size_idx_e * size_idx_f * size_idx_b;
	size_B = size_idx_f * size_idx_d * size_idx_c * size_idx_e;
    ...
    // Run the Kernels
    initmemmodule_();
	tccg_26_cuda(size_idx_a, size_idx_b, size_idx_c, size_idx_d, size_idx_e, size_idx_f, host_C, host_A, host_B);
