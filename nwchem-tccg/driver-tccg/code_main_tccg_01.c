...
int main(int argc, char** argv)
{
	...
	int size_B;
	int size_internal;
    long long int tmp_num = (long long int)(size_idx_a * size_idx_b * size_idx_c * size_idx_d * 2);
    ...
    // Run the Kernels
    initmemmodule_();
    tccg_01_cuda(size_idx_a, size_idx_b, size_idx_c, size_idx_d, host_C, host_A, host_B);
