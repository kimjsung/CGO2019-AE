...
//      >>> t3 [a,16,b,16,c,16,d1,16,d2,16,e,16] += sum(f,16) * t2 [e,c,b,f,a] * v2 [f,d1,d2];
//
int main(int argc, char** argv)
{
	...
	size_A = size_idx_e * size_idx_c * size_idx_b * size_idx_f * size_idx_a;
	size_B = size_idx_d * size_idx_f;
    ...
    // Run the Kernels
    initmemmodule_();
	tccg_07_cuda(size_idx_a, size_idx_b, size_idx_c, size_idx_d, size_idx_e, size_idx_f, host_C, host_A, host_B);
