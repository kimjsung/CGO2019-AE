...
//
//  ab-cad-dcb
//  t3 [a,16,b,16] += sum(c,16) * t2 [c,a,d] * v2 [d,c,b];
//
int main(int argc, char** argv)
{
	...
	int size_B;
	int size_internal;
    long long int tmp_num = (long long int)((long long int)((long long int)(size_idx_a * size_idx_b * size_idx_c) * size_idx_d) * 2);

	//  ab-cad-dcb
    //  t3 [a,16,b,16] += sum(c,16) * t2 [c,a,d] * v2 [d,c,b];
	size_internal 	= size_idx_c * size_idx_d;
	size_C = size_idx_a * size_idx_b;
	size_A = size_idx_c * size_idx_a * size_idx_d;
	size_B = size_idx_d * size_idx_c * size_idx_b;
	...
	printf ("==========================================================================================================\n");
	printf (">>> Problem Size (a,b) and (c,d): (%2d,%2d) and (%2d,%2d)\n", size_idx_a, size_idx_b, size_idx_c, size_idx_d);
    ...
    // Run the Kernels
    initmemmodule_();
    tccg_14_cuda(size_idx_a, size_idx_b, size_idx_c, size_idx_d, host_C, host_A, host_B);
