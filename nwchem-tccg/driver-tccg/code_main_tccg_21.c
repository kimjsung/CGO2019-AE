...
int main(int argc, char** argv)
{
	...
	size_B = size_idx_f * size_idx_d * size_idx_e * size_idx_c;
    ...
    // Run the Kernels
    initmemmodule_();
	tccg_21_cuda(size_idx_a, size_idx_b, size_idx_c, size_idx_d, size_idx_e, size_idx_f, host_C, host_A, host_B);
...
/*
                if (tmp_r_idx == 4096)
                {
                    if (idx_e == 0 && idx_f == 0)
                    {
                        printf ("idx a,b,c,d: %d, %d, %d, %d\n", idx_a, idx_b, idx_c, idx_d);
                    }
                    
                    printf ("[%4d] t2[%4d]: %f, v2[%4d]: %f >>> %f\n", idx_e + (idx_f) * size_idx_e, 
                        idx_a + (idx_e + (idx_b + (idx_f) * size_idx_b) * size_idx_e) * size_idx_a,
                    h_A[idx_a + (idx_e + (idx_b + (idx_f) * size_idx_b) * size_idx_e) * size_idx_a],
                        idx_f + (idx_d + (idx_e + (idx_c) * size_idx_e) * size_idx_d) * size_idx_f,
                    h_B[idx_f + (idx_d + (idx_e + (idx_c) * size_idx_e) * size_idx_d) * size_idx_f], 
                    h_C_chk[tmp_r_idx]);
                }
*/
