...
//	t3 [a,16,b1,16,b2,16,c,16,d,16,e,16] += sum(f,16) * t2 [e,f,c,a,d] * v2 [b1,b2,f];
//
int main(int argc, char** argv)
{
	...
	int size_B;
	int size_internal;
    long long int tmp_num = (long long int)((long long int)(size_idx_a * size_idx_b * size_idx_c * size_idx_d * size_idx_e * size_idx_f) * 2);

	//	#t3 [a,16,b,16,c,16,d,16,e,16] += sum(f,16) * t2 [e,f,c,a,d] * v2 [b,f];
	size_internal 	= size_idx_f;
	size_C = size_idx_a * size_idx_b * size_idx_c * size_idx_d * size_idx_e;
	size_A = size_idx_e * size_idx_f * size_idx_c * size_idx_a * size_idx_d;
	size_B = size_idx_b * size_idx_f;
    ...
    // Run the Kernels
    initmemmodule_();
    tccg_08_cuda(size_idx_a, size_idx_b, size_idx_c, size_idx_d, size_idx_e, size_idx_f, host_C, host_A, host_B);
