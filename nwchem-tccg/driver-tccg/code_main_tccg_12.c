...
int main(int argc, char** argv)
{
	...
	int size_B;
	int size_internal;
    long long int tmp_num = (long long int)((long long int)((long long int)(size_idx_a * size_idx_b) * size_idx_c) * 2);
	...
	printf ("==========================================================================================================\n");
	printf (">>> Problem Size (a,b) and (c): (%2d,%2d) and (%2d)\n", size_idx_a, size_idx_b, size_idx_c);
    ...
    // Run the Kernels
    initmemmodule_();
    tccg_12_cuda(size_idx_a, size_idx_b, size_idx_c, host_C, host_A, host_B);
...
//
void post_Correctness(double* h_C, double* h_C_chk, double* h_A, double* h_B, int size_idx_a, int size_idx_b, int size_idx_c)
{
    //  #abc-adc-bd
    //  #t3 [a,16,b,16] += sum(c,16) * t2 [a,c] * v2 [c,b];
