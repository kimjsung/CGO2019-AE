...
int main(int argc, char** argv)
{
    ...
    // Run the Kernels
    //extern "C" void case_20_cuda(int ad, int bd, int cd, int dd, int ed, int fd, double *t3, double *t2, double *v2) {
   	initmemmodule_();
	tccg_31_cuda(size_idx_a, size_idx_b, size_idx_c, size_idx_d, size_idx_e, size_idx_f, size_idx_g, host_C, host_A, host_B);
