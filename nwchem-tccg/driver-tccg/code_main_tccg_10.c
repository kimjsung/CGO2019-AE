...
int main(int argc, char** argv)
{
	...
	size_A = size_idx_e * size_idx_b;
	size_B = size_idx_a * size_idx_e * size_idx_c * size_idx_d;
    ...
    // Run the Kernels
    initmemmodule_();
    tccg_10_cuda(size_idx_a, size_idx_b, size_idx_c, size_idx_d, size_idx_e, host_C, host_A, host_B);
